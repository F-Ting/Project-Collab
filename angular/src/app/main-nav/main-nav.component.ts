...
export class MainNavComponent {
  ...
  loggedInLinks = [
    ...
    this.createNavLinkObject("Profile",`user/${this.currentUser}`),
  ]
  ...
  ngOnInit() {
    this.navLinks = this.currentUser == null ? this.commonLinks.concat(this.loggedOutLinks) : this.commonLinks.concat(this.loggedInLinks)
  }
