...
INSERT INTO projects (name, description, github, url, project_start_date, image, status) VALUES ('Google', 'Google LLC is an American multinational technology company that specializes in Internet-related services and products, which include online advertising technologies, search engine, cloud computing, software, and hardware.  Please contact Sergey Brin at SergeyBrin@google.ca to get involved!', 'https://github.com/google', 'https://google.com', '1998-11-25T05:00:00.000Z', 'https://i.imgur.com/Hjpgzeq.jpg', 'approved');
